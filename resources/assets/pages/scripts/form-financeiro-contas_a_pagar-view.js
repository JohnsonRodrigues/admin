var FormCustom = function () {
    ...
    var contasAPagarForm = function () {
        $('option[value=""]').attr("disabled", "disabled");
    }


    var contasAPagar = function () {
        ...
        $('#btnGerarParcelas').on('click', function () {
            ...
            for (i = 1; i <= qtde_parcelas; i++) {
                ...
                var select = $('<select>').attr({'class': 'form-control'}).attr('name', 'pago[]').attr('id', 'pago_' + i).append(new Option('NÃO', '0', true, true)).append(new Option('SIM', '1', false, false));
